...
export type RateLimitWhereInput = {
  ...
  endpoint?: Prisma.StringFilter<"RateLimit"> | string
...
export type RateLimitScalarWhereWithAggregatesInput = {
  ...
  endpoint?: Prisma.StringWithAggregatesFilter<"RateLimit"> | string
...
export type RateLimitOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "identifier" | "endpoint" | "createdAt", ExtArgs["result"]["rateLimit"]>
...
export interface RateLimitFieldRefs {
  ...
  readonly endpoint: Prisma.FieldRef<"RateLimit", 'String'>
